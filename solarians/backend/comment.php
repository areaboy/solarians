...
$statement = $db->prepare('INSERT INTO comments_solar
...
$update2= $db->prepare('UPDATE posts_solar set total_comments =:total_comments where id=:id');
...
$comment_result = $db->prepare('SELECT COUNT(*) AS cntcomment FROM comments_solar WHERE postid=:postid');
