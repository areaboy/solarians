...
<!--end post comments notifications-->
 ...
 <li class="navgate_no"><a title='Add New Solar Updates' data-toggle='modal' data-target='#myModal_solar' style="color:white;font-size:14px;">
<button class="category_post1">Add New <br>Solar Updates</button></a></li>




 <li class="navgate_no"><a title='Solar Installation Companies Mapping' href="map_companies.php" style="color:white;font-size:14px;">
<button class="category_post1">Solar Installation<br> Companies Map</button></a></li>



 <li class="navgate_no"><a title='Solar Chatbot AI' data-toggle='modal' data-target='#myModal_chatbot' style="color:white;font-size:14px;">
...
//$res= $db->prepare("SELECT count(*) as totalcount FROM posts_solar WHERE country_nickname=:country_nickname");

$res= $db->prepare("SELECT count(*) as totalcount FROM posts_solar");
$res->execute(array());
$t_row = $res->fetch();
...
<span style='color:purple'>https://www.youtube.com/watch?v=<span style='color:red'><b>kwqHwlhQoLA</b></span></span>
